...
@include('admin.layout._partials.breadcrumbs', [
            ...
            'items' => [
                    ...
                    [ 'title' => 'Редактирование города ' . $city->name .  'в стране ' . $country->name, 'action' => '', 'active' => TRUE ],
            ]
        ])
@stop
...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">Редактирование города {{ $city->name }} в стране {{ $country->name }}</h3>

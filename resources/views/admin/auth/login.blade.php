...
<head>
    ...
    <title>Расчёт расстояния | Авторизация</title>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{ asset('assets/plugins/adminlte/plugins/iCheck/square/blue.css') }}">
...
<div class="login-box">
    <div class="login-logo">
        <a href="{{ url('/') }}"><b>Расчёт расстояния</b></a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        ...
        <form action="{{ action('Admin\Auth\AuthController@login') }}" method="post">
            {!! csrf_field() !!}
